...
int Line3DWrap::setModel(mat4 m) {
    return Line3D::setModel(m);
}

int Line3DWrap::setCamera(mat4 c) {
    return Line3D::setCamera(c);
}
...
void wrap_Line3D() {
    ...
    .add_property("model_matrix", &Line3DWrap::model, &Line3DWrap::setModel);
    ;
}