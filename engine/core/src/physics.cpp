...
CollisionBox::CollisionBox(double x, double y, double z, double gravity, double rx, double ry, double rz, double sx, double sy, double sz)
{
    body = new RigidBody;
    setState(x,y,z, gravity, rx, ry, rz, sx, sy, sz);
...
void CollisionBox::setState(double x, double y, double z, double gravity, double rx, double ry, double rz, double sx, double sy, double sz)
{
    body->position = glm::dvec3(x, y, z);
    body->orientation = glm::dquat(1,0,0,0);
